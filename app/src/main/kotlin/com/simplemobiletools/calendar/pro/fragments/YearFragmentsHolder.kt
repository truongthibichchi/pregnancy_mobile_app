...
class YearFragmentsHolder : MyFragmentHolder() {
            ...
            addOnPageChangeListener(object : ViewPager.OnPageChangeListener {
                ...
                override fun onPageSelected(position: Int) {
                    ...
                    if (position < years.size) {
                        (activity as? CalendarMainActivity)?.updateActionBarTitle("${getString(R.string.app_launcher_name)} - ${years[position]}")
                    }
                }
            })
    ...
    override fun updateActionBarTitle() {
        (activity as? CalendarMainActivity)?.updateActionBarTitle("${getString(R.string.app_launcher_name)} - $currentYear")
    }
